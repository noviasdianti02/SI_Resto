                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div>
                                ...
                                <img class="wd-100 rounded-circle"
                                    src="{{ !empty($profileData->foto) ? url('upload/admin_images/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                                    alt="profile" />
                            ...
                            <form method="POST" action="{{ route('admin.profile.store') }}" class="forms-sample"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control" id="exampleInputUsername1"
                                        autocomplete="off" placeholder="no telpon" value="{{ $profileData->phone }}">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Alamat</label>
                                    <input type="text" name="address" class="form-control" id="exampleInputUsername1"
                                        autocomplete="off" placeholder="alamat" value="{{ $profileData->address }}">
                                </div>
                                <div class="mb-3">
